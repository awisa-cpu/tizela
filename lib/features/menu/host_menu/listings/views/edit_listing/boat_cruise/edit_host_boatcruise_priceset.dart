...
class EditHostBoatcruisePriceset extends StatefulWidget {
  final BoatCruiseModel boatCruise;
  const EditHostBoatcruisePriceset({super.key, required this.boatCruise});

  @override
  State<EditHostBoatcruisePriceset> createState() =>
      _EditHostBoatcruisePricesetState();
}

class _EditHostBoatcruisePricesetState
    extends State<EditHostBoatcruisePriceset> {
