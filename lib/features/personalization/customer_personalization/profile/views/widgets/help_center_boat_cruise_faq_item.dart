...
class HelpCenterBoatCruiseFaqItem extends StatefulWidget {
  final HelpCenterFaqsModel shorletFaq;
  const HelpCenterBoatCruiseFaqItem({super.key, required this.shorletFaq});

  @override
  State<HelpCenterBoatCruiseFaqItem> createState() =>
      _HelpCenterBoatCruiseFaqItemState();
}

class _HelpCenterBoatCruiseFaqItemState
    extends State<HelpCenterBoatCruiseFaqItem> {
  //
